          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="/home_page">Home</a> <span class="mx-2">/</span> <strong>Listings</strong></div>
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="data:image/jpeg;base64,{{ base64_encode($car->image) }}" alt="Image" class="img-fluid">
              </div>
