          ...
          <div class="row align-items-end ">
            <div class="col-lg-12">
              ...
              <div class="intro">
                ...
                <div class="pb-4"><strong class="text-black">Posted on  {{ $car->created_at->format('F j, Y') }}</strong></div>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <img src="data:image/jpeg;base64,{{ base64_encode($car->image) }}" alt="" class="img-fluid p-3 mb-5 bg-white rounded">
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="categories">
                ...
                <li><a href="#">{{$category->name}} <span>({{$category->cars_count}} )</span></a></li>
               @endforeach
              </div>
            </div>
            <div class="sidebar-box">
