					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" method = "post" action ="/admin_users/update/{{$user->id}}" data-parsley-validate class="form-horizontal form-label-left">
									@csrf
									@method('put')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="name" value="{{$user->name}}"required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
