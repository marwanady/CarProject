					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-pars method= "post" action= "/admin_cars/update/{{$car->id}}" enctype="multipart/form-data" ley-validate class="form-horizontal form-label-left">
									   @csrf
									   @method('put')	
									  ...
									  <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="title" value= "{{$car->title}}"  name = "title" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="price" class="form-control" value= "{{$car->price}}" type="number" name="price" required="required">
											</div>
										</div>
										<div class="item form-group">
