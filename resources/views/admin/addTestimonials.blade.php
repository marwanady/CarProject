					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" enctype="multipart/form-data" method= "post" action= "/admin_testimonials/store"data-parsley-validate class="form-horizontal form-label-left">
										@csrf
